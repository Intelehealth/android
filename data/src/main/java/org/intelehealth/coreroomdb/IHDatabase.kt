...
@Database(
    entities = [Appointment::class, Concept::class, Encounter::class, FollowupScheduleNotification::class, LocalNotification::class, MediaRecord::class, Observation::class, Patient::class, PatientAttribute::class, PatientAttributeTypeMaster::class, PatientLocation::class, Provider::class, ProviderAttribute::class, UserCredentials::class, Visit::class, VisitAttribute::class],
    version = 1,
    exportSchema = false
)
...
abstract class IHDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         */
        fun getInstance(context: Context): IHDatabase = INSTANCE
