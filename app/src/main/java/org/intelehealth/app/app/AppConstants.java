...
public class AppConstants {
    ...
    public static final String STETHOSCOPE_FOLDER_PATH = Environment.getExternalStoragePublicDirectory(
            Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + File.separator + "Intelehealth_Audio" + File.separator;
